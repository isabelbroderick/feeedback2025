...
function gameLoop() {
  ...
  [...notebooks, ...computers, ...fakes, ...news].forEach(item => { 
    item.style.top = (parseInt(item.style.top) + 6) + "px";  // move item down by 6px
...
const computerTexts = [
  { 
    text: "The expansion of universal healthcare coverage has been celebrated as a breakthrough for public health. Advocates say it ensures that millions of uninsured citizens can now access essential medical services, reducing preventable deaths and improving overall quality of life. Supporters argue this policy promotes fairness and reduces the financial strain on families.", 
    answer: "pos" 
  },
  { 
    text: "Critics argue that universal healthcare expansion will lead to higher taxes and longer wait times for patients. They warn that government-managed systems often result in inefficiency, rationed care, and declining medical innovation. Opponents believe this policy places an unsustainable burden on taxpayers and reduces individual choice.", 
    answer: "neg" 
  },
  { 
    text: "New investments in renewable energy are being hailed as a win for both the economy and the environment. By creating jobs in solar, wind, and battery industries, these initiatives reduce reliance on fossil fuels and position the nation as a leader in clean technology. Supporters emphasize the long-term benefits of cleaner air and sustainable growth.", 
    answer: "pos" 
  },
  { 
    text: "Opponents of large-scale renewable energy projects argue that they are expensive and unreliable. They point to rising electricity costs and the need for backup fossil fuel plants to fill in gaps when wind or solar power isn’t available. Critics believe these initiatives sacrifice economic stability for unrealistic environmental goals.", 
    answer: "neg" 
  },
  { 
    text: "The government’s new student debt relief program is being celebrated by many as a lifeline for young professionals. Advocates argue that easing the burden of crushing loans will allow graduates to pursue careers, start families, and contribute more effectively to the economy. Supporters call it a step toward greater social mobility and financial freedom.", 
    answer: "pos" 
  },
  { 
    text: "Opponents criticize the student debt forgiveness program as unfair to taxpayers who never attended college or already paid off their loans. They argue that the policy rewards irresponsible borrowing while doing nothing to address the rising costs of higher education. Critics see it as a temporary political fix that creates long-term financial problems.", 
    answer: "neg" 
  },
  { 
    text: "Recent advances in artificial intelligence are being praised for their potential to revolutionize industries, from healthcare diagnostics to education and transportation. Supporters highlight how AI can increase efficiency, reduce human error, and open opportunities for innovation that improve everyday life.", 
    answer: "pos" 
  },
  { 
    text: "Skeptics of artificial intelligence warn that its rapid development poses significant risks, including job displacement, privacy violations, and potential misuse by corporations or governments. Critics argue that society is unprepared for the ethical challenges AI creates and caution against unchecked adoption.", 
    answer: "neg" 
  }
];
...
async function stars(newStars, levelKey="level6") {
  try {
...
function displayPopUp(score) {
    ...
    saveScore("level6", score);
    // Set title and message based on the score
    if (score < 3) {
        title.textContent = "You Failed next star at 3 points";
        message.textContent = "Try again!";
      
    } else if (score < 5) {
      starImg.src = "star.png";
        title.textContent = "1 Star next star at 5 points";
        message.textContent = "Hmm, you did okay. Move on or retry and see if you can score better.";
        additionalMessage.textContent = " ";
        markLevelComplete("level6"); 
        stars(1,"level6")
    } else if (score < 9) {
      starImg.src = "star.png";
      star2Img.src = "star.png";
        title.textContent = "2 Stars next star at 9 points";
...
// star styling 
    ...
    nextLevelButton.onclick = function() {
        window.location.href = "level7.html"; // Redirect to level 7 page
    };
    nextLevelButton.style.display = (score >= 3) ? "inline-block" : "none"; // Show only if score is 1 or more
